...
import validation.{EmailDoesNotMeetCriteria, NameDoesNotMeetCriteria, PasswordDoesNotMeetCriteria, SurnameDoesNotMeetCriteria, UserAccountValidation, UsernameDoesNotMeetCriteria}
