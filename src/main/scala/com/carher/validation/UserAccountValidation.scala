...
case object NameDoesNotMeetCriteria extends UserAccountValidation {
  override def errorMessage: String = "Name is mandatory and cannot contain spaces, numbers or special characters."
}

case object SurnameDoesNotMeetCriteria extends UserAccountValidation {
  override def errorMessage: String = "Surname is mandatory and cannot contain spaces, numbers or special characters."
}

case object UsernameDoesNotMeetCriteria extends UserAccountValidation {
  override def errorMessage: String = "Username cannot contain special characters."
}

case object EmailDoesNotMeetCriteria extends UserAccountValidation {
  override def errorMessage: String = "Email no valid"
}

case object PasswordDoesNotMeetCriteria extends UserAccountValidation {
  override def errorMessage: String = "Password must be at least 10 characters long, including an uppercase and a lowercase letter, one number and one special character."
}
